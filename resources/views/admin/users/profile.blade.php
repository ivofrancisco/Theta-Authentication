...
@section('content')
    ...
    <div class="g-main-content">
	        ...
	        <div class="row">
	            ...
	            <div class="col-sm-12 col-md-5">
	                ...
	                <div class="s-profile-card shadow-sm">
	                    ...
	                    <div class="s-profile-head" style="background-image: linear-gradient(0deg, rgba(35, 44, 56, 0.35), rgba(69, 79, 92, 0.25)), url({{ asset('/images/profile-bg_01.jpg') }})">
	                        ...
	                        <div id="g-profile-uploader">
                                ...
                                <input type="hidden" name="current_photo" form="edit-profile-form" value="{{ $user->media }}">
	                        </div>
	                ...
	                <div class="s-dashboard-tabs">
	                    ...
	                    <div class="s-dsh-tabs-content">
	                        ...
	                        <div class="s-dsh-content-item opened">
	                            ...
	                            <form action="/admin/users/update" id="edit-profile-form" method="POST" enctype="multipart/form-data">
	                            	@csrf
	                            	@method('PUT')
	                                ...
	                                <div class="form-row">
	                                    ...
	                                    <div class="form-group col-sm-12 col-md-5">
	                                        ...
	                                        <input type="text" name="first_name" class="form-control brd md" id="first-name" value="{{ old('first_name') ?? $user->first_name }}">
	                                    </div>
	                                    <!-- End: form-group -->
	                                    <!-- Begin: form-group -->
	                                    <div class="form-group col-sm-12 col-md-7">
	                                        <label for="last-name">Último Nome</label>
	                                        <input type="text" name="last_name" class="form-control brd md" id="last-name" value="{{ old('last_name') ?? $user->last_name }}">
	                                    </div>
	                                    <!-- End: form-group -->
	                                </div>
	                                <!-- End: form-row -->
	                                ...
	                                <div class="form-row">
	                                    ...
	                                    <div class="form-group col-sm-12 col-md-7">
	                                        ...
	                                        <input type="text" name="email" class="form-control brd md" id="email" value="{{ old('email') ?? $user->email }}">
	                                    </div>
	                                    <!-- End: form-group -->
	                                    <!-- Begin: form-group -->
	                                    <div class="form-group col-sm-12 col-md-5">
	                                        <label for="phone">Telefone</label>
	                                        <input type="text" name="phone" class="form-control brd md" id="phone" value="{{ old('phone') ?? $user->phone }}">
	                                    </div>
	                                    <!-- End: form-group -->
	                                </div>
	                                <!-- End: form-row -->
	                                ...
	                                <div class="form-group">
	                                    ...
	                                    <input type="text" name="job" class="form-control brd md" id="job" value="{{ old('job') ?? $user->job }}">
	                                </div>
	                                <!-- End: form-group -->
        ...
        <!-- END: CONTENT  -->
         ...
         <!-- Begin: g-profile-uploader -->
        <div id="g-profile-uploader" style="display: none">
            <!-- Begin: g-manage-photo -->
            <div class="g-manage-photo editable shadow-sm">
                <i class="icon-edit_05"></i>
            </div>
            <!-- End: g-manage-photo -->
            @if($user->media)
            	<img src="/images/{{ $user->media }}" class="clickable shadow" alt="upload image">
            @else
            	<img src="/images/cat.jpg" class="clickable shadow" alt="upload image">
            @endif
            <div class="clickable"></div>
            <input type="file" name="photo" class="photo empty" id="add-image1" style="display: none">
            <input type="hidden" name="current_photo" value="{{ $user->media }}">
        </div>
        <!-- End: g-profile-uploader -->
