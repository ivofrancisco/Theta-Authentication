...
<div class="g-authentication login"
    style="background-image: linear-gradient(135deg, rgba(0, 0, 0, 0.35), rgba(1, 1, 1, 0.40)), url({{ asset('/images/confirm.svg') }})">
    ...
    <form action="{{ url('user/confirm-password') }}" class="g-auth-form g-create-edit-form" method="POST">
        ...
        <div class="form-group">
            <label for="password">Confirme a sua palavras-passe</label>
