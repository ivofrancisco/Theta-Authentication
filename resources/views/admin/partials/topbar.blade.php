        ...
        <div class="g-wrapper">
            ...
            <div class="g-header-nav">
                ...
                <a href="/admin/users/{{ Auth::user()->id }}/profile" class="g-header-profile" title="O meu Perfil">
                    <img src="/images/{{ Auth::user()->media ? Auth::user()->media : 'cat.jpg' }}" class=g-profile-pholder" alt="user">
                </a>
                ...
                <form action="{{ route('logout') }}" class="g-header-settings" method="POST" title="Sair">
                    @csrf
                    <button class="btn btn-link" type="submit" style="text-decoration: none"><i class="icon-power"></i></button>
                </form>
                <!-- End: g-header-logout -->
            </div>
            <!-- End: g-header-nav -->
